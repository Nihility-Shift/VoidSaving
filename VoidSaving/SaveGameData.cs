...
namespace VoidSaving
{
    public class SaveGameData
    {
        ...
        public int NextSectorID; // Sector IDs are generated by clients during the join process, and jumping into/out of sectors utilizes this ID.

        public int NextMissionID; // Mission IDs are generated by clients during the join process (join process simulates generating every section and sector), and if mission is not the same loading fails.
    ...
    public struct FullSectorData
    {
        public FullSectorData(GameSessionSector Sector, int solarSystemIndex)
        {
            ...
            EnemyLevelMin = Sector.Difficulty.ObjectLevelRange.Min;
            EnemyLevelMax = Sector.Difficulty.ObjectLevelRange.Max;
            State = Sector.ObjectiveState;
            IsMainObjective = Sector.SectorObjective?.IsMainObjective ?? false;
            MissionID = Sector.SectorObjective?.Missions.FirstOrDefault()?.Id ?? 1;
            SectorID = Sector.Id;
        }
